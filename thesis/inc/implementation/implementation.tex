...
Since the previous sections already solved the goals defined by the milestones up to the library, the next bit to explain is the built library itself.
...
Afterwards one can insert some products.
...
If the parameter is omitted, the term's frequency is 1.
